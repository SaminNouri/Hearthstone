...
public class CollectionController  implements Initializable {
   ...
   static void setMyLogger(LoggerCreator myLogger) {
        CollectionController.myLogger = myLogger;
    }
   ...
   Drawer getDrawer() {
    ...
    void setCard7(ImageView card7) {
        Card7 = card7;
    }

    void setCard6(ImageView card6) {
        Card6 = card6;
    }
   ...
   ImageView getCard4() {
    ...
    void setCard4(ImageView card4) {
        Card4 = card4;
    }

    void setCard3(ImageView card3) {
        Card3 = card3;
    }

    void setCard2(ImageView card2) {
        Card2 = card2;
    }
    ...
    @FXML
    void BackAction(ActionEvent event) throws IOException, LineUnavailableException, UnsupportedAudioFileException {
    ...
    void deck_10_Action(ActionEvent event) throws Exception {
        ...
        mapper.addRequest(Mapper.RequestType.Load_CompleteDeck);
        update();
    ...
    void submitSearch(MouseEvent event) {
        myLogger.logger.log(Level.INFO,"buttonClicked:"+"SubmitSarch");
    ...
    void filterAction(ActionEvent event) throws Exception {
        myLogger.logger.log(Level.INFO,"buttonClicked:"+"Filter");
